...
class RegisterForm(forms.ModelForm):
    ...
    adminparola = forms.CharField(max_length=100, label='Admin Yetkisi İcin Gerekli Parola', widget=forms.PasswordInput)
    ...
    def clean_adminparola(self):
        adminparola =self.cleaned_data.get('adminparola')
        if adminparola !='TuGo.bin453':
            raise forms.ValidationError("Admin Parolanız eşleşmiyor!")
        return adminparola
